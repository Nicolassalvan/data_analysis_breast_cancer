...
On affiche les variables avec un coefficient de corrélation supérieur à 0.95.
...
```
On supprime area_mean car elle est corrélée avec radius_mean et radius_worst. 
